...
class CustomUserManager(BaseUserManager):
    def create_user(self, email_or_phone, password=None, user_type=None, **extra_fields):
        ...
        user = self.model(email_or_phone=email_or_phone, user_type=user_type, **extra_fields)
...
class FarmerProfile(models.Model):
    ...
    class CustomUserManager(BaseUserManager):
        ...
        def create_superuser(self, email_or_phone, password=None, user_type=None, **extra_fields):
            extra_fields.setdefault('is_staff', True)
            extra_fields.setdefault('is_superuser', True)
            return self.create_user(email_or_phone, password, user_type, **extra_fields)
